...
PATH_TO_JAVA_PROJECTS="C:/Users/admin/repo_for_lm/bug"
PATH_TO_STORE_INDEXED_PROEJCTS ="C:/Users/admin/chenw2k/idx_pkl2"
PATH_TO_STORE_THE_DICTIONARY="C:/Users/admin/chenw2k/dict_file_2"
PATH_TO_STORE_EMBEDDINGS = "C:/Users/admin/chenw2k/emb_new.npy"
...
def main():
    ...
    with tf.Session(graph=graph) as session:
      ...
      np.save(PATH_TO_STORE_EMBEDDINGS, final_embeddings)
      print("saved embeddings to ", PATH_TO_STORE_EMBEDDINGS)
      #final_embeddings = tf.identity(final_embeddings, name="emb")

      save_path = saver.save(session, "./joke.ckpt")
